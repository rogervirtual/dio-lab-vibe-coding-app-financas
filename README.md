# 💸 Exercicio - App de Finanças Pessoais com Vibe Coding

Exercicio de projeto referente desafio de Vibe Coding baseado em linguagem natural, utilizando IA.
---
## 📝 PRD utilizando Copilot Web

```markdown
# PRD - App para Organização Financeira em linguagem natural
## Resumo
Aplicativo para organização de finanças pessoais via linguagem natural.  

## Objetivo
Criação de um controle financeiro minimalista, para atender ao exercicio do desafio.

## Público-Alvo
Usuarios com pouca experiência na utilização de controles financeiros.

## Funcionalidades principais
1. Registrar gastos via chat: Utilizando linguagem natural.
2. Classificar transações: Categorias baseadas no texto.
3. Definir metas financeiras.
4. Dicas: Assistente sugere melhorias no controle financeiro.
5. Relatórios.

## Design Universal
- Interface simples
- Navegação fácil e compativel por comandos de voz
- Feedbacks

## Entregável da IA
Gerar MVP:
- Principais telas (chat, metas, relatórios)
- Recursos (NLP, categorização e motor de recomendações)
- Validação inicial com usuários reais
- Linguagem acessível em português
- Princípios de Design Universal 
```
---
## 🎯 Resultado
MVP funcional no Lovable:  
